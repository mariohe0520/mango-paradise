...
L(3,  { moves:25, gems:['murloc','orc','elf','mage','knight'], objectives:[{type:'clear',target:15,gem:'orc',icon:'👹'},{type:'clear',target:15,gem:'elf',icon:'🧝'}], stars:[800,1500,2200] }),
...
L(7,  { moves:30, gems:['murloc','orc','elf','mage','knight'], objectives:[{type:'clear',target:30,gem:'mage',icon:'🧙'}], stars:[1800,3000,4500] }),
...
L(13, { moves:25, gems:['orc','elf','mage','knight','dwarf'], objectives:[{type:'clear',target:25,gem:'orc',icon:'👹'},{type:'clear',target:25,gem:'mage',icon:'🧙'}], stars:[3500,5500,8000] }),
...
L(23, { moves:30, gems:['elf','mage','knight','dwarf','undead'], objectives:[{type:'clear',target:40,gem:'elf',icon:'🧝'},{type:'special',target:3,specialType:'bomb',icon:'💣'}], stars:[6500,10000,14000] }),
...
L(25, { moves:30, gems:['orc','elf','mage','knight','dwarf','undead'], objectives:[{type:'clear',target:25,gem:'mage',icon:'🧙'},{type:'clear',target:25,gem:'undead',icon:'💀'},{type:'score',target:5000,icon:'⭐'}], stars:[7000,11000,15000] }),
...
L(37, { width:7, height:9, moves:30, gems:['mage','knight','dwarf','undead','mango'], objectives:[{type:'clear',target:40,gem:'mage',icon:'🧙'},{type:'clear',target:30,gem:'mango',icon:'🥭'}], stars:[10500,16000,21500] }),
...
L(64, { width:9, height:8, moves:33, gems:['elf','mage','mango','dragon','phoenix'], objectives:[{type:'clear',target:40,gem:'elf',icon:'🧝'},{type:'combo',target:12,icon:'🔥'}], stars:[24000,35000,47000] }),
...
// =========== Ch9: 时光之穴 (81-90) ===========
L(81, { moves:33, gems:['mage','dwarf','mango','dragon','phoenix','elf'], objectives:[{type:'clear',target:30,gem:'mage',icon:'🧙'},{type:'clear',target:30,gem:'elf',icon:'🧝'}], stars:[32000,46000,62000] }),
