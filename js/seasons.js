...
const Seasons = {
    ...
    // ══════════════════════════════════════
    SEASONAL_BOSSES: {
        1: { name: '年兽', emoji: '🐲', hp: 20000, taunt: '新年快乐？我来给你发红包——骷髅红包！' },
        ...
        6: { name: '水龙王', emoji: '🐲', hp: 25000, taunt: '龙舟竞赛？先过我这关！' },
        7: { name: '银河守卫', emoji: '🌌', hp: 20000, taunt: '牛郎织女永远不会相见！' },
        8: { name: '月兔魔王', emoji: '🐰', hp: 22000, taunt: '月饼是我的！芒果也是我的！' },
        9: { name: '焰火恶魔', emoji: '🎆', hp: 28000, taunt: '让焰火变成你的噩梦！' },
        10: { name: '南瓜王', emoji: '🎃', hp: 24000, taunt: '不给糖？那就给你骷髅！' },
        11: { name: '饕餮', emoji: '🍗', hp: 20000, taunt: '所有的食物...都是我的！' },
